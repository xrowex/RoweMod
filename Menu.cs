...
namespace rowemod
{
    public static class Menu
    {
        ...
        static void DrawTabContent()
        {
            switch (currentTab)
            {
                case Tab.Physics:
                    ...
                    GUILayout.Box("Manuals", coloredBoxStyle, GUILayout.Height(25), GUILayout.ExpandWidth(true)); // Colored separator
        ...
        static void DrawTabs()
        {
            ...
            if (GUILayout.Button("<b>Camera</b>", highQualityButtonStyle)) { SetCurrentTab(Tab.Camera); }
        ...
        public static void DrawGraphicsSettings()
        {
            try
            {
                ...
                GUILayout.Box("", highQualityButtonStyle, GUILayout.Height(5), GUILayout.ExpandWidth(true)); // Separator
            }
            catch (Exception ex)
            {
        ...
        public static void ApplyGlobalGraphicsSettings(int taaQualityIndex)
        {
            ...
            foreach (var hdrpCamera in cachedHDRCameras)
            {
                ...
                {
                    case 0:
                        hdrpCamera.antialiasing = UnityEngine.Rendering.HighDefinition.HDAdditionalCameraData.AntialiasingMode.None;
                        break;
                    case 1:
                        hdrpCamera.antialiasing = UnityEngine.Rendering.HighDefinition.HDAdditionalCameraData.AntialiasingMode.FastApproximateAntialiasing;
                        break;
                    case 2:
                        hdrpCamera.antialiasing = UnityEngine.Rendering.HighDefinition.HDAdditionalCameraData.AntialiasingMode.TemporalAntialiasing;
                        break;
                    case 3:
                        hdrpCamera.antialiasing = UnityEngine.Rendering.HighDefinition.HDAdditionalCameraData.AntialiasingMode.SubpixelMorphologicalAntiAliasing;
                        break;
                }
            }
        }
