...
$targets = @{
    ...
    '0x7DE910' = 'System.Void MashBox.Character.Scripts.EquipSlot::ApplyRenderPolicy()'
    '0x7F15C0' = 'System.Boolean MashBox.Character.Scripts.EquipSlot/<EnumEquip>d__80::MoveNext()'
